...
public class MappingPanel{
	...
	private static JButton mapEquipmentsBtn = new JButton("Mapper �quipements");
	...
	public static void showMappingPanel(int choice) {
		...
		if(choice==1) {// if user clicked on "mapper �quipements"
			setCurrentp(2);
			position2.setText("Plan des emplacements des �quipements du workspace "+workSpace.getId_work_space()+" a mapper");
