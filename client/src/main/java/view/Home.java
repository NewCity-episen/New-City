...
public class Home{
	...
	private static String[] companyNames = new String[] {"Wayne entrepries", "LexCorp", "Stark industries", 
												 "The Daily Panet", "Daily bugle", "Pyramid Transnational",
												 "Planet express", "Big Kahuna Burger", "Red apple"};
	private static JComboBox<String> companyNameList= new JComboBox<String>(companyNames);
	private static String selectedCompany = (String)companyNameList.getSelectedItem();
	...
	public static JComboBox<String> getCompanyNameList() {
